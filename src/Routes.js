...
const Component = (props) => {
    ...
    return (
        <Routes>
                ...
                <Route path="/products" element={<Investors {...props} title={'Investor'} />} />
                <Route path="/products" element={<Stages {...props} title={'Stages'} />} />
                <Route path="/products/list" element={<FundingRoundList {...props} title={'FundingRound '} />} />
                <Route path="/products/tiles" element={<StartupTiles {...props} title={'Startup'} />} />
        </Routes>
    )
