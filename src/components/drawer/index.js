                ...
                <ListItem disablePadding sx={{ display: 'block' }}>
                    <List component="div" disablePadding>
                        ...
                        <ListItemButton onClick={() => NavigateTo("/products")} sx={{ height: 50 }}>
                            ...
                            {open && <ListItemText primary="Stages" sx={{ pl: 1 }} />}
                        </ListItemButton>
                        <ListItemButton onClick={() => NavigateTo("/products/list")} sx={{ height: 50 }}>
                            <ListItemIcon sx={{ minWidth: 30 }}>
                        ...
                        <ListItemButton onClick={() => NavigateTo("/products/tiles")} sx={{ height: 50 }}>
                            <ListItemIcon sx={{ minWidth: 30 }}>
                                <Tooltip title="Startup">
                                    <AddLink />
                                </Tooltip>
                            </ListItemIcon>
                            {open && <ListItemText primary="Startup" sx={{ pl: 1 }} />}
                        </ListItemButton>
                    </List>
                </ListItem>
            </List>
